...
public class ForecastAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        // Today list item requests detailed color art image
        if (getItemViewType(cursor.getPosition()) == VIEW_TYPE_TODAY) {
            imageResourceId = Utility.getArtResourceForWeatherCondition(weatherId);
        }
        // Other list items request smaller icon
        ...
        if(cursor.getPosition() == 0 && getItemViewType(cursor.getPosition()) == VIEW_TYPE_FUTURE_DAY) {
            viewHolder.dateView.setText(Utility.getDayName(context, date));
        } else {
        ...
        // Set image content description to weather description for accessibility purposes
    ...
    // ViewHolder object holds all intialized children views to be saved under a parent views tag
