...
import com.discflux.android.sunshine.sync.SunshineSyncAdapter;
...
public class MainActivity extends ActionBarActivity implements ForecastFragment.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.weather_detail_container) != null) {
            ...
            // (res/layout-sw720dp). If this view is present, then the activity should be
            // in two-pane mode.
            mTwoPane = true;
        ...
        // Call sync adapter initialization
