package com.discflux.android.sunshine.service;
...
import com.discflux.android.sunshine.FetchWeatherTask;
...
/**
 * Created by Phil on 13/10/2015.
 */
public class SunshineService extends IntentService {

    private final String LOG_TAG = FetchWeatherTask.class.getSimpleName();
    private final static String LOCATION_QUERY_EXTRA = "locationString";
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                inserted = getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI,
                        cvArray);
            }
